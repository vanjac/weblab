...
const glConst = WebGL2RenderingContext

const basicVertShaderSrc = `
 ...
 * @param {WebGLRenderingContext} gl
 */
export function basicVertShader(gl) {
    return createShader(gl, basicVertShaderSrc, gl.VERTEX_SHADER)
}
