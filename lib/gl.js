...
export function createScreenRectVAO(gl) {
    ...
    gl.enableVertexAttribArray(boundAttr.aPosition)
    gl.vertexAttribPointer(boundAttr.aPosition, 2, gl.FLOAT, false, 0, 0)
    ...
    gl.enableVertexAttribArray(boundAttr.aTexCoord0)
    gl.vertexAttribPointer(boundAttr.aTexCoord0, 2, gl.FLOAT, false, 0, 0)
